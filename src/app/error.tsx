...
const Error = ({ error, reset }: ErrorProps) => {
  return (
    <MainContainer>
      ...
      <p className="mb-3">
        <Link href="/" className="text-rose-600 no-underline hover:underline">Return to the home page</Link>
      </p>
      ...
      <button
        type="button"
        className="btn mt-6 font-serif hover:text-rose-600 lowercase p-0"
        onClick={() => reset()}
      >
        Try again
