...
const Error = ({ error, reset }: ErrorProps) => {
  return (
    <MainContainer>
      ...
      <p className="mb-3">
        <Link href="/" className="text-lime-500 no-underline hover:underline">Return to the home page</Link>
      </p>
      ...
      <button
        type="button"
        className="btn mt-6 font-serif hover:text-lime-500 lowercase p-0"
        onClick={() => reset()}
      >
        Try again
